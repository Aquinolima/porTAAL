...
, `cpf_cliente`='$cpf', `rg_cliente`='$rg', `telefone_cliente`='$telefone'
, `celular_cliente`='$celular', `sobrenome_cliente`='$sobrenome', `email_cliente`='$email'
, `senha_cliente`='$senha', `cep_cliente`='$cep', `cidade_cliente`='$cidade'
, `endereço_cliente`='$endereço', `estado_cliente`='$estado', `pref_contato`='$resposta_checkbox' WHERE `codigo`='$cod'";
