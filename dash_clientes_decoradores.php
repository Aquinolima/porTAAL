                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-12 text-center">
                                    <h1 class="display-4 mt-3" style="color: #ecede8;"> <i> Decoradores Cadastrados</i> </h1>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                $executa3 = "SELECT * FROM perfil_serviço WHERE profissão_cliente_serviço = 'Decorador ' ORDER BY codigo";
